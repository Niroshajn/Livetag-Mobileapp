...
//       {/* HEADER */}
//       <View className="px-4 py-4 border-b border-gray-800 mt-8">
...
//           className="flex-1 border border-gray-600 py-2 rounded flex-row items-center justify-center"
//         >
//           <Play size={14} color="white" />
//           <Text className="text-white text-xs ml-1">Execute</Text>
//         </TouchableOpacity>
